...
const myWork = () => {
  return (
    <div className={Styles.div}>
      <a href='https://ratinabijashvili.github.io/Bike-app'>
        <img src={Image1} className={Styles.img} alt='image1' />
      </a>
      <a href='https://ratinabijashvili.github.io/url-shortening-api/'>
        <img src={Image2} className={Styles.img} alt='image2' />
      </a>
      <a href='https://ratinabijashvili.github.io/intro-section-with-dropdown-navigation/'>
        <img src={Image3} className={Styles.img} alt='image3' />
      </a>
      <a href='https://ratinabijashvili.github.io/insure-landing-page/'>
        <img src={Image4} className={Styles.img} alt='image4' />
      </a>
      <a href='https://ratinabijashvili.github.io/pricing-component-with-toggle/'>
        <img src={Image5} className={Styles.img} alt='image5' />
      </a>
      <a href=' https://ratinabijashvili.github.io/four-card-feature-section/'>
